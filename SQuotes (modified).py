...
#  @three_six_mafia - someone guy
'''
       _      _____                  _            _      _  _____
      | |    |____ |                | |          | |    (_)|  _  |
  ___ | |__      / /__   __     ___ | |__    ___ | |     _ | |/' | ___
 / __|| '_ \     \ \\ \ / /    / __|| '_ \  / _ \| |    | ||  /| |/ __|
| (__ | | | |.___/ / \ V /  _ | (__ | | | ||  __/| |____| |\ |_/ /\__ \
 \___||_| |_|\____/   \_/  (_) \___||_| |_| \___|\_____/|_| \___/ |___/
...
class ShitQuotesMod(loader.Module):
    ...
    async def qcmd(self, message: Message) -> None:
        ...
        """
        await message.edit("[Quotes] Processing...")
        ...
        return [
            {
                ...
                "media": None,
                "entities": None,
                "author": {"id": user.id, "name": name, "avatar": avatar, "rank": "", "via_bot": None},
